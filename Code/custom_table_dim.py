...
- Dimensions parsed from the user's note are injected per item
...
def extract_dimensions_from_note(note: str) -> dict:
    ...
    # Round table: diameter + height range if present
...
def inject_dimensions_into_items(items: list, note_dims: dict) -> list:
    ...
    for it in items:
        if it.get("dimensions"):  # already set
            continue
...
if __name__ == "__main__":
    ...
    # <<< NEW: parse & inject dimensions from the user's note >>>
